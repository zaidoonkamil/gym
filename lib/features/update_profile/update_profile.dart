      ...
      child: BlocConsumer<AppCubit, AppStates>(
        ...
        builder: (context, state) {
          ...
          if(cubit.ready ){
            ...
            subsecribeController.text=timeSubscription;
            widghthController.text=weight;
                                      ...
                                      CustomFormField(
                                        ...
                                        onTap: () {
                                          showDatePicker(
                                              ...
                                              .then((value) {
                                            value ??= DateTime.now();
                                            subsecribeController.text =DateFormat.yMd().format(value);
                                            var x = DateFormat.y().format(value);
                                            var z = DateFormat.M().format(value);
                                            var y = DateFormat.d().format(value);
                                            var c = '$x-$z-$y';
                                        ...
                                        if (formKey.currentState!.validate()) {
                                          if (image.isNotEmpty) {
                                            cubit.updateData(
                                              ...
                                              subTime: subsecribeController.text,
